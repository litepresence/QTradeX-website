...
[Back to main site](/) — QTradeX is a lightning-fast Python framework for
building, backtesting, and deploying algorithmic trading bots.

- **[Getting Started](getting-started.md)** — install, quick bot example
